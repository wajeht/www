    ...
    <span>
        <button @click="showModal = true"
            class="
                        flex gap-1
                        items-center
                        hover:outline  hover:outline-[color:#37362F] 
                        py-1 px-4 rounded-sm font-light hover:bg-[color:#0B0A08] bg-[color:#15140E] text-[color:#D4D3D2] hover:text-[color:#FBF0DF]">
            {{ label }}
        </button>
